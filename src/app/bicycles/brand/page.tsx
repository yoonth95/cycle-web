...
export default function BrandPage() {
  const { brandCategories } = bicycleBrandsData;
  ...
  return (
    <div className="bg-gray-50">
      <div className="container mx-auto px-2 py-8 sm:px-4 lg:max-w-[70rem]">
        <SectionHeader
          title="브랜드별 자전거"
          description="신뢰할 수 있는 브랜드의 자전거를 만나보세요. 각 브랜드만의 특별한 기술과 디자인을 경험하실 수 있습니다."
        />
            ...
            >
              <CardContent className="flex h-full flex-col overflow-hidden p-0">
                ...
                <div className="mt-4 flex h-full flex-col justify-between px-6 pb-6 sm:mt-6">
                  <Link href={`/bicycles/brand/${category.slug}`} className="mt-auto block">
